...
public class JacksonTrackerPayload implements Payload {

    private final String TAG = JacksonTrackerPayload.class.getSimpleName();
    ...
    public void addMap(Map map, Boolean base64_encoded, String type_encoded, String type_no_encoded) {
        ...
        if (base64_encoded) { // base64 encoded data
            objectNode.put(type_encoded, com.snowplowanalytics.snowplow.tracker.utils.Util.base64Encode(mapString));
